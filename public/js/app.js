...
var Ball, Object, Player, events, host, keyCodes, leftPlayer, objects, paused, pongScreen, ready, rightPlayer, scores,
...
Ball = (function(superClass) {
  ...
  Ball.prototype.restart = function() {
    ...
    return $("#score").text(scores[0] + " - " + scores[1]);
  };
...
$(function() {
  var frameCount, pausedText, scoreText, socket;
  pausedText = $("#paused");
  ...
  setInterval(function() {
    ...
    if (ready && !paused) {
      ...
      if (host) {
        if (++frameCount >= 20) {
          frameCount = 0;
          return socket.emit("ball", objects[2].x(), objects[2].y());
        }
      }
    }
  }, 1000 / 60);
